...
/// this step cannot itself fail), then tries `POST /admin/control/
/// member/add` against each already-confirmed voter ordinal `0..ordinal`
/// in turn until one accepts. `POST /admin/control/
