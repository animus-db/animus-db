...
/// Magic in the footer, identifying a CustosDB SSTable **v1**: uncompressed
...
#[allow(dead_code)]
const MAGIC_V1: u64 = 0x4355_5354_4F53_5331; // "CUSTOS S1"
/// Magic in the footer, identifying a CustosDB SSTable **v2**: compression-capable
/// blocks (`tag || payload || crc`, payload optionally LZ4). The current writer
/// always stamps this.
const MAGIC_V2: u64 = 0x4355_5354_4F53_5332; // "CUSTOS S2"
